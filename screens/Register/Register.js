...
const Register = (props) => {
  ...
  return (
    // Dismiss the keyboard when tapping outside text input fields
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <View style={styles.container}>
        ...
        {/* Ensure the keyboard doesn't block interactions */}
        ...
        >
          ...
          <View style={styles.btnwrapper}>
            ...
            />
            <Text style={styles.ortext}> Or signup with social network</Text>
